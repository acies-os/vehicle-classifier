...
from acies.QuantizedModels.inference import ModelForInference
...
def main(
    ...
    logger.debug(f'AdaQuant currently only supports audio and seismic modality, not single modality')
