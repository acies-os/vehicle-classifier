...
def process_run_node(
    run_id, node_id, label_model_path, formation_model_path, targets, formation_targets, base_path, output_dir
):
    ...
    for t_0 in range(total_seconds):
        ...
        data = {
            'rs10/geo': {t_0: geo_packet, t_0 + 1: geo_packet},
            'rs10/mic': {t_0: audio_packet, t_0 + 1: audio_packet},
        }
