...
AUDIO_THRESHOLDS = [3e+10, 8.6e+10, 35e+10, 80e+10]
GEO_THRESHOLDS = [5.9e+10, 6.25e+10, 7.8e+10, 9e+10]
...
class DistInference(object):
    def __init__(self, model_path=None, init_distance = INIT_DISTANCE, threshold_audio= AUDIO_THRESHOLDS, threshold_geo = GEO_THRESHOLDS ,past_geo = PAST_GEO, future_geo = FUTURE_GEO):
        """
